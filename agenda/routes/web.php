...
Route::post('/evento/validar_cita/{start}', [App\Http\Controllers\EventoController::class, 'validar_cita']);
Route::post('/evento/actualizar', [App\Http\Controllers\EventoController::class, 'update']);
